...
# CineJunction Website

Explore a website with complete movie information and easily book cinema tickets all in one place.
...
```bash
  git clone https://github.com/chnoumanejaz/cinejunction-app.git
```

# Have a look: (Demo)

https://cinejunction-nouman.netlify.app/
